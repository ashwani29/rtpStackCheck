...
//        {
            ...
            System.err.println("CLient A ssrc: " + ssrc);
            final RtpParticipant participant = RtpParticipant
                    .createReceiver(new RtpParticipantInfo(ssrc), "127.0.0.1", 10000, 10001);
            sessions[0] = new MultiParticipantSession("Client A" , 8, participant);
//            sessions[0].init();

        //Server is assigned to ssrc 300.
        //TODO --> make sure it doesn't get assigned to the current client
